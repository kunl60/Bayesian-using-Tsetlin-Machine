...
# 3. Discover Markov Blankets using Tsetlin Machine
# Using the encoded dataframe for discovery
tm_mb = TsetlinMB(num_epochs=5, number_clauses=10, top_n=5, T=10, s=5)
discovery_results = tm_mb.run(encoded_df, encoded_df.astype(str))
