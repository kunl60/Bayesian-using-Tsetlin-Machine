"""
BOSS run on ECG5000 (OpenML), a real-world regression dataset with an
unknown ground-truth DAG. Discovers the skeleton/Markov Blankets, then
scores each node's discovered MB (and, for comparison, all raw features)
...
def main():
    ...
    raw_samples, _ = load_ecg5000_dataset()
    ...
    print("===== BOSS Results (BIC, ECG5000) =====")
