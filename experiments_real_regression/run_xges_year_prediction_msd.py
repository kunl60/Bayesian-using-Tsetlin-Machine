"""
XGES run on YearPredictionMSD (OpenML), a real-world regression dataset with an
...
def main():
    ...
    # this tractable.
    raw_samples, _ = load_year_prediction_msd_dataset()
    ...
    print("===== XGES Results (BIC, YearPredictionMSD) =====")
