"""
XGES run on Parkinsons Telemonitoring (OpenML), a real-world speech/voice-
signal regression dataset with an unknown ground-truth DAG. Discovers the
skeleton/Markov Blankets via XGES (Extremely Greedy Equivalence Search), then
scores each node's discovered MB (and, for comparison, all raw features) as
predictors for that node via Linear Regression / KNN / SVR (see
...
def main():
    ...
    print("===== XGES Results (BIC, Parkinsons Telemonitoring) =====")
