...
def main():
    # Evaluate over multiple runs, each with a different but fixed data-sampling
    # seed, so the 3 samples differ from each other but the whole script is reproducible
    run_seeds = [1, 2, 3, 4, 5]
    ...
    print("\n===== CPC Results (chi-square, discrete) - Summary (mean ± std across runs) =====")
